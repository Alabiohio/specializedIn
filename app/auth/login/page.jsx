...
import '@/styles/signupLoginPg.css';
    ...
    return (
        <div className="min-h-screen w-full grid lg:grid-cols-2">
            ...
            <div className="hidden lg:flex flex-col justify-center items-center bg-zinc-900 relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-600/30 via-violet-600/30 to-rose-600/30 animate-gradient" />
                <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20" />

                <div className="relative z-10 p-12 text-center space-y-6 max-w-lg">
                    <div className="w-20 h-20 bg-gradient-to-tr from-indigo-500 to-rose-500 rounded-2xl mx-auto shadow-2xl shadow-indigo-500/30 flex items-center justify-center transform rotate-3 hover:rotate-6 transition-transform duration-500">
                    ...
                    <p className="text-zinc-400 text-lg leading-relaxed">
                        Turn your expertise into opportunity. Connect, trade skills, and grow with your local community.
                    </p>
                </div>

                {/* Floating cards animation placeholder could go here */}
            </div>
                ...
                <div className="w-full max-w-md space-y-10">
                    <div className="text-center lg:text-left space-y-2">
                        ...
                        <p className="text-zinc-500 dark:text-zinc-400">
                            ...
                            <Link href="/auth/signup" className="font-semibold text-green-600 hover:text-green-500 transition-colors signup-login-link">
                                Sign up for free
                            </Link>
                        </p>
                    </div>
